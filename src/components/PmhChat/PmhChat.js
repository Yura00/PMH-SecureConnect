...
import PmhAvatar from './PmhAvatar';
import PmhChatInteractionManager from './PmhChatInteractionManager';
...
class PmhChat extends React.Component {
  constructor(props) {
    super(props);
...
PmhChat.childContextTypes = {
  actionSheet: PropTypes.func,
  getLocale: PropTypes.func,
};

PmhChat.defaultProps = {
  messages: [],
  text: undefined,
